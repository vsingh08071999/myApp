...
import 'package:newapplication/scanner/cropImage.dart';
import 'package:newapplication/scanner/documentProvider.dart';
...
class _ShowImageState extends State<ShowImage> {
  ...
  void initState() {
    ...
    super.initState();
    print(
        "initState ${widget.bl}   ${widget.br}    ${widget.tl}     ${widget.tr}   ${widget.animatedListKey}");
